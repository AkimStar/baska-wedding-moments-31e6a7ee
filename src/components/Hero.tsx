...
const Hero = () => {
  ...
  useEffect(() => {
    // Create a timeline for staggered text animations
    const tl = gsap.timeline({ defaults: { ease: "power3.out" } });
    
    // Split text into characters for more dramatic animation
    const titleChars = titleRef.current?.querySelectorAll('.char');
    const subtitleChars = subtitleRef.current?.querySelectorAll('.char');
    
    // Animate title characters with staggered effect
  ...
  return (
    <section id="home" className="relative min-h-screen w-full overflow-hidden">
      ...
      >
        ...
        {/* Atmospheric overlay with light leaks and film grain */}
        ...
        {/* Hero content with dramatic typography animations */}
