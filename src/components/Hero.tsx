...
const Hero = () => {
  ...
  return <section id="home" className="relative h-screen w-full overflow-hidden">
      <div className="absolute inset-0 z-0" id="hero-background">
        <img src="https://images.unsplash.com/photo-1537633552985-df8429e8048b?auto=format&fit=crop&q=80&w=2340&ixlib=rb-4.0.3" alt="Сватбена двойка" className="w-full h-full object-cover opacity-90" />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-6">
        <div className="animate-fade-in-up p-8 rounded-lg backdrop-blur-sm bg-black/5 max-w-xl border border-white/10">
          ...
          <p className="animate-fade-in-up opacity-0 [animation-delay:600ms] max-w-2xl text-lg md:text-xl mb-10">Улавяме Вашите мечтани сватбени моменти със сърце и душа</p>
          <Button onClick={scrollToGallery} className="animate-fade-in-up opacity-0 [animation-delay:900ms] bg-gradient-to-r from-[#F9F4EC]/90 to-[#E6D7C3]/90 
